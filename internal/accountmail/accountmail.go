...
// Message represents a message to be sent as a account email.
type Message struct {
...
// Notifier defines the interface for sending account emails through various providers.
type Notifier interface {
	// Sends the account email message using the specified provider
