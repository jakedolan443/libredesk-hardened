...
// Send sends a account email message via email.
func (e *Email) Send(msg accountmail.Message) error {
...
func (e *Email) Name() string {
	return accountmail.ProviderEmail
}
...
func (e *Email) prepareEmail(subject, content string, recipients []string, msg accountmail.Message) smtppool.Email {
